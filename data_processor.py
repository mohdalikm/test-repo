...
class DataProcessor:
    ...
    def inefficient_pandas_operations(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        result_df['log_value'] = result_df['new_value'].apply(lambda x: np.log(x) if x > 0 else 0)
    ...
    def create_sample_data_files(self, output_dir: str, file_count: int = 5, rows_per_file: int = 1000):
        """
    ...
    def clear_cache(self):
        """
        Method to clear cache - but note this should be called automatically
